...
export const projectsData: Project[] = [
  {
    ...
    problemSolution: {
      problem:
        "Existing hosting portals were slow and had poor UX for mobile users, causing high bounce rates during the checkout process.",
      solution:
        "Implemented a server-side rendered (SSR) architecture with optimized payment flows, reducing checkout time by 45%.",
    },
    metrics: [
      {
        label: "Performance",
  ...
  },
  {
    ...
    problemSolution: {
      problem:
        "Manual tutor matching was slow and prone to human error, often leading to multiple tutors applying for filled positions.",
      solution:
        "Engineered an 'Auto-Rejection' system where selecting one tutor automatically notifies and closes other applications for that specific slot.",
    },
    metrics: [
  ...
  },
  {
    ...
    problemSolution: {
      problem:
        "Tourists struggled with inconsistent pricing and unverified guides in the local tourism market.",
      solution:
        "Built a centralized booking system with fixed transparent pricing and a mandatory certification badge for guides.",
    },
    metrics: [
  ...
  },
  {
    ...
    fgithubUrl:
      "https://github.com/MISFOfficial/online-group-study-assignment-client-site",
    bgithubUrl:
      "https://github.com/MISFOfficial/online-group-study-assignment-client-server",
    features: [
      "Peer Marking System",
    ...
    problemSolution: {
      problem:
        "Students lacked a structured way to participate in peer-review, often leading to biased or disorganized feedback.",
      solution:
        "Designed a blind-marking system where student identities are hidden during the evaluation process to ensure fairness.",
    },
    metrics: [
  ...
  },
  {
    ...
    problemSolution: {
      problem:
        "Urban gardeners had fragmented information sources, making it hard to find region-specific planting advice.",
      solution:
        "Created a searchable 'Knowledge Vault' where tips are categorized by climate zone and plant types.",
    },
    metrics: [
