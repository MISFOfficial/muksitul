      ...
      <div className="container mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
          ...
          <div className="lg:col-span-8 space-y-16">
            <div className="space-y-6">
              ...
              >
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 rounded-full bg-white/10 backdrop-blur-md border primary-border opacity-0 group-hover/img:opacity-100 transition-all duration-300 scale-90 group-hover/img:scale-100 pointer-events-none">
            ...
            <div className="space-y-8 p-10 primary-rounded bg-white/[0.02] border primary-border">
          ...
          <div className="lg:col-span-4 lg:pl-10">
            ...
            >
              <div className="p-10 rounded-[2.5rem] bg-white/[0.03] border primary-border relative overflow-hidden">
                {/* Decoration */}
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-xl font-bold text-white">
                      {certificate.duration} ({certificate.timeTaken})
                    </span>
                  </div>
                ...
                <div className="mt-16 pt-10 border-t primary-border">
                    ...
                    <div className="w-32 h-32 bg-white/10 primary-rounded flex items-center justify-center p-2">
                      <div className="w-full h-full border primary-border grid grid-cols-4 grid-rows-4 gap-1 opacity-20">
                        {[...Array(16)].map((_, i) => (
                          <div
                            key={i}
                            className={`bg-white ${i % 3 === 0 ? "opacity-100" : "opacity-0"}`}
                          />
                        ))}
                      </div>
                    </div>
                    <span className="text-[10px] font-black text-white/20 tracking-tighter">
                      CERT-ID: {certificate.id}-GLOBAL-VERIFIED
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 rounded-[2rem] bg-green-500/5 border border-green-500/10 flex items-center gap-6">
                <div className="w-14 h-14 primary-rounded bg-green-500/10 flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-white/30 text-[10px] mt-1 uppercase font-bold tracking-tight">
        ...
        {isImageModalOpen && (
          <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 md:p-10">
            ...
            <motion.button
              ...
              onClick={() => setIsImageModalOpen(false)}
              className="absolute top-6 right-6 z-[160] w-12 h-12 rounded-full bg-white/10 border primary-border flex items-center justify-center text-white hover:bg-[#FF5C58] hover:border-[#FF5C58] transition-all"
            >
              <X size={24} />
            </motion.button>
            ...
            <motion.div
              ...
              className="relative z-[155] primary-rounded overflow-hidden border primary-border max-h-[90vh] max-w-full"
            >
              <Image
                src={certificate.image}
                alt={certificate.title}
