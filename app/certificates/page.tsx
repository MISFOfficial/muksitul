  ...
  return (
    <main className="relative min-h-screen  ">
      ...
      <div className="container mx-auto px-6 py-24">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="space-y-4">
              ...
              <p className="text-white/40 max-w-xl text-lg font-medium">
                A structured repository of certified expertise and specialized
                training.
              </p>
            </div>

            <div className="flex flex-col items-end">
              <span className="text-8xl font-black text-white/[0.03] leading-none mb-2">
        ...
        {/* Bottom CTA */}
        <div className="max-w-5xl mx-auto mt-24 p-12 rounded-[3rem] bg-white/[0.02] border primary-border flex flex-col items-center text-center gap-6">
          <Award size={48} className="text-[#FF5C58]" />
          <h2 className="text-3xl font-black text-white uppercase tracking-tighter">
            Commitment to Growth
          </h2>
          <p className="text-white/40 max-w-lg">
            I am constantly expanding my technical horizons. New certifications
            are added as I complete advanced specializations.
          </p>
          <Link href="/#contact">
