...
export default function CreateCmsProjectPage() {
  const router = useRouter();
  const { mutate: createCmsProject, isPending } = useCreateCmsProject();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    createCmsProject(data, {
      onSuccess: () => {
        toast.success("CMS Project created successfully!");
      ...
      <div className="flex items-center justify-between mb-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-black uppercase tracking-[0.2em] text-white">
            New <span className="text-[#0abab5]">CMS Project</span>
          </h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex items-center justify-end gap-6 pt-10 border-t primary-border">
          ...
          >
            ...
            <span>{isPending ? "Adding..." : "Save Project"}</span>
          </button>
        </div>
      </form>
    </div>
