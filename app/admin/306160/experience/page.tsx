          ...
          allExperience.map((exp: any) => (
            ...
            >
              ...
              <div className="flex items-center gap-6">
                <div className="w-16 h-16 rounded-2xl border primary-border  flex items-center justify-center overflow-hidden shrink-0 shadow-lg">
                  {exp.image?.url ? (
                    <Image
                      width={100}
                      height={100}
              ...
              <div className="flex items-center justify-between md:justify-end gap-6 w-full md:w-auto mt-4 md:mt-0 pt-4 md:pt-0 border-t md:border-t-0 primary-border">
                <div className="flex flex-col items-start md:items-end gap-1.5">
                  <div className="flex items-center gap-2 px-4 py-2 rounded-full border primary-border bg-white/[0.02] text-[#0abab5] text-xs font-black uppercase tracking-widest shadow-inner">
                    <Calendar size={14} />
                    {exp.duration}
                  </div>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="hidden lg:flex w-10 h-10 rounded-full border primary-border items-center justify-center group-hover:bg-[#0abab5] group-hover:border-[#0abab5] transition-all duration-300">
                    <ArrowUpRight
                      size={18}
