...
export default function BioPage() {
  return (
    <div className="flex flex-col items-center justify-center  text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <button className="mt-8 px-10 py-3.5 border primary-border hover:border-white/20 hover:bg-white/5 primary-rounded font-bold transition-all uppercase tracking-widest text-sm text-white/60 hover:text-white">
        Coming Soon
      </button>
    </div>
  );
