  ...
  return (
    <section id="contact" className="relative overflow-hidden">
      <div className="relative z-10">
        {/* Main Card */}
        <div className="overflow-hidden primary-rounded border primary-border">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div className="grid grid-cols-3 gap-4 mt-8">
                  {[
                    ...
                    <div
                      key={idx}
                      className="bg-white/10 backdrop-blur-sm primary-rounded p-4 text-center hover:scale-110 hover:rotate-6 transition-transform"
                    >
                      <item.icon
